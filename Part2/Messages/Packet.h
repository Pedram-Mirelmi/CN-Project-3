...
public:
    Packet() = default;
    Packet(const std::vector<char>& body, const std::string& source, const std::string& destination);
    Packet(std::vector<char>&& body, const std::string& source, const std::string& destination);
